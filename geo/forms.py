...
class LocationForm(forms.ModelForm):
    ...
    location = forms.CharField(
        max_length=255,
        required=True,
        help_text='Any address or description of a place that Google can convert into a street address. (ex: "El Cortez Apartments, Phoenix")',
    )
    ...
    def save(self, commit=True, *args, **kwargs):
        ...
        obj.latitude = self.result.latitude
        obj.longitude = self.result.longitude
        if commit:
            obj.save()
        return obj
